        ...
        <nav class="flex items-center justify-between flex-wrap p-6 bg-nav fixed">
            ...
            <div :class="open ? 'block': 'hidden'" class="w-full flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-sm sm:flex-grow">
                    ...
                    <a href="#project" class="block uppercase no-underline lg:inline-block lg:mt-0 text-teal hover:text-teal-lighter mr-4">
                        Projects
                    </a>
...
<!--     
<nav class="flex items-center justify-between flex-wrap p-6 bg-nav fixed clearfix">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
                ...
                <a href="/" class="no-underline block mt-4 uppercase sm:inline-block text-teal hover:text-teal-lighter mr-4">
                        Home
                    </a>
                <a href="#about" class="block uppercase no-underline lg:inline-block lg:mt-0 text-teal hover:text-teal-lighter mr-4">
                    About Me
