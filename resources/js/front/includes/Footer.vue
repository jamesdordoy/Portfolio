    ...
    >
        ...
        >
            <p class="mt-2">
                <a
                    aria-label="facebook"
                    href="https://www.facebook.com/dordoy"
                    rel="noreferrer"
                    target="_blank"
                >
                    <font-awesome-icon
                        :icon="['fab', 'facebook']"
                        class="text-4xl lg:text-5xl hover:text-blue-700"
                ...
                <a
                    aria-label="twitter"
                    href="https://twitter.com/JDordoy"
                    rel="noreferrer"
                    target="_blank"
                >
                    <font-awesome-icon
                        :icon="['fab', 'twitter']"
                        class="text-4xl lg:text-5xl hover:text-blue-400"
                        :class="`text-${$store.getters.primaryThemeTextColour}`"
                    />
                </a>
                <span
                ...
                <a
                    aria-label="linkedin"
                    href="https://www.linkedin.com/in/james-dordoy-a80686110/"
                    rel="noreferrer"
                    target="_blank"
                >
                    <font-awesome-icon
                        :icon="['fab', 'linkedin']"
                        class="text-4xl lg:text-5xl hover:text-blue-500"
                        :class="`text-${$store.getters.primaryThemeTextColour}`"
                    />
                </a>
                <span
                ...
                <a
                    aria-label="github"
                    href="https://github.com/jamesdordoy"
                    rel="noreferrer"
                    target="_blank"
                >
                    <font-awesome-icon
                        :icon="['fab', 'github']"
                        class="text-4xl lg:text-5xl hover:text-gray-500"
                        :class="`text-${$store.getters.primaryThemeTextColour}`"
                    />
                </a>
                <span
                ...
                <a
                    aria-label="jsfiddle"
                    href="https://jsfiddle.net/user/JamesDordoy/fiddles/"
                    rel="noreferrer"
                    target="_blank"
                >
                    <font-awesome-icon
                        :icon="['fab', 'jsfiddle']"
                        class="text-4xl lg:text-5xl hover:text-yellow-500"
                        :class="`text-${$store.getters.primaryThemeTextColour}`"
                    />
                </a>
            </p>
        ...
        <div
            ...
            "
        >
            <h3 :class="`text-${$store.getters.primaryThemeTextColour}`">
                &copy; James Dordoy
            </h3>
            <p>
                <router-link :to="'/privacy'">
                    <a
                        class="teal-300 mt-4 block"
            ...
            <div id="newsletter">
                ...
                >
                    ...
                    <div class="md:flex md:items-center pt-2">
                        <h4
                            class="md:text-right mb-1 md:mb-0 pr-4"
                            :class="`text-${$store.getters.primaryThemeTextColour}`"
                        >
...
export default {
    ...
    methods: {
        async submitNewsletterForm() {
            ...
            const recaptureResponse = await RecaptureService.validateToken(
                token
            );
            ...
            const newsletterResponse = await ContactService.newsletterSignUp(
                this.payload
            ).catch((error) => {
