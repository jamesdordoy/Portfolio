            ...
            <div class="flex items-center md:justify-between py-4">
                ...
                <div class="w-1/6 md:w-auto text-white font-medium">
                    <ul class="list-reset flex">
                        <back-nav-link :url="'/back'" :text="'Dash'">
                        ...
                        <back-nav-link :url="'/back/contact'" :text="'Contact'">
                            <i class="fa fa-phone" aria-hidden="true"></i>
                        </back-nav-link>
                        <back-nav-link :url="'/back/blog'" :text="'Blog'">
                ...
                <div
                    class="w-1/6 md:w-auto md:flex text-right"
                    @click="dropdown = !dropdown"
                >
                    <div>
                        <img
                            class="inline-block h-8 w-8 rounded-full"
                            src="https://avatars0.githubusercontent.com/u/19800113?s=400&u=d1353fc02ae27265ad97d7444340aec9979c9ec0&v=4"
                            alt=""
                        />
                    </div>
                ...
                <div
                    class="absolute dropdown p-6 bg-nav animated cursor-pointer"
                    :class="{
                        'fadeInDown ': dropdown,
                        hidden: !dropdown,
                        fadeOut: !dropdown,
